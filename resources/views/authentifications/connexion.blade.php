                ...
                <div
                    ...
                    <form method="post" action="{{ route('etudiant.login') }}" class=" px-2 ">
                      ...
                      {{--  <div class="mt-2">
                        ...
                        <input type="text"
                            class=" my-2 py-2 rounded-3xl text-[#0c0265] focus:border-[#0c0265] font-bold px-8 w-full"
                               type="number" name="matricule"
                            placeholder="Entrez votre matricule">

                        <input id="password" class=" my-6 py-2 rounded-3xl text-[#0c0265] focus:border-[#0c0265] font-bold px-8 w-full"
