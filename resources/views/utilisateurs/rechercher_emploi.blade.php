...
@section('sous-contenu')
    ...
    {{-- <div class="flex flex-wrap justify-center items-center w-full">
        <div class="container col-lg-6">
            <h2 class="text_center text-center">Emploi du temps</h2>
            <form action="" method="post">
                <label for="salle" class="block">Choisissez la salle</label>
                <select name="salle" id="salle" class="form-select mb-2">
                    <option value="">D1</option>
                    <option value="">D2</option>
                    <option value="">D3</option>
                </select>
                <label for="filiere" class="block">Choisissez la filière</label>
                <select name="filiere" id="filiere" class="form-select mb-2">
                    <option value="">IG1</option>
                    <option value="">IG2</option>
                    <option value="">IG3</option>
                </select>
                <button id="btn_rechercher" type="submit" class="btn btn-success fo mt-4">
                    Rechercher
                </button>
            </form>
        </div>

        <div class="container col-lg-10 mb-0">
            ...
            <table class="my_table mt-5 table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="px-2 py-1">7h-8h</td>
                        <td rowspan="3" class="bg-blue-500 text-white p-2" style="background-color: #4FA5E4;">
                            <div class="container">
                                <div class="row rounded-5">
                                    <div class="row p-2 text-light m-0 font-bold"
                                        style="background-color: whitesmoke; color: black !important;">
                                        IG3-ARI
                                    </div>
                                    <div class="row p-2 text-light m-0 font-bold">
                                        Ireep Service réseaux 7h-10h
                                    </div>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td class="py-2">8h-9h</td>
                        <td class="cours-2 row-span-5">
                            <div class="container">
                                <div class="row rounded-5 bg-whitesmoke text-black">
                                    <div class="row p-2 font-bold">
                                        IG3-ARI
                                    </div>
                                    <div class="row p-2 font-bold">
                                        Ireep
