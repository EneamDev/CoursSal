                            ...
                            <div class="first-block">
                                <div class="tera border-b ">
                                    <div class="   "><span
                                            class="text-[#263685] flex justify-end text-2xl lg:hidden cursor-pointer"><i
                                                id="close-icons" class="fa-solid fa-close " onclick=""></i></span></div>
                                </div>
                                ...
                                <div class="portfolio my-2 border-b ">
                                    <h2 class=" text-center">
                                        <a href="#"><i class=" py-2 text-xl fa-solid fa-calendar-days opacity-60"></i>
